...
#define CUSTOM_MACHINE_NAME "FAB-DLP"
...
#define HOMING_FEEDRATE {50*60, 50*60, 0.5*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3152.7,500}  // default steps per unit for Ultimaker
